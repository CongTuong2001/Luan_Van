  ...
  submit = async (event) => {
    ...
    await axios
      ...
      .then((res) => {
        ...
        sessionStorage.setItem("mhs", res.data.username);
        sessionStorage.setItem("ten_lop", res.data.ten_lop);
        console.log(res);
      })
        ...
        <Body>
          ...
          <Container>
            <App_logo_container>
              ...
              <Comment>Hệ thống hỗ trợ quản lý điểm học sinh</Comment>
              <Comment1>Xây dựng và phát triển bởi B1906608</Comment1>
              <Comment2>Trường Đại học Cần Thơ</Comment2>
            </App_logo_container>
            <Form_container>
